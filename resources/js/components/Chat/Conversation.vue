<template>
    <div class="chat-window is-active" v-if="userConversation">
        <div class="chat-window__wrapper">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex flex-col leading-tight">
                        <div class="mt-1 flex items-center">
                            <span
                                class="text-lg font-medium text-gray-700 mr-3"
                                >{{ userConversation.name }}</span
                            >
                        </div>
                        <span class="text-sm text-muted">
                            {{ userConversation.email }}</span
                        >
                    </div>
                </div>
            ...
            >
                ...
                <div class="chat-input w-full px-4 mb-4">
                    <div
                        class="flex flex-row items-center h-16 rounded-xl px-4 bg-white"
                    >
                        <div>
                            <button
